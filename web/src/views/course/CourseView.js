    ...
    <div>
        ...
        <Collapse isOpen={isOpen}>
            ...
            <Card>
                ...
                <CardBody>Classes will start on time and end as scheduled. Please be there time and try as much as you can to not miss a class otherwise you are going to miss a lot. You will attend each class and actively participate in the discussions duringclass. If you are uncomfortable with public speaking, or if English is not your native language, please talk to the instructor in the first two weeks of the course to establish ways to make you more comfortable in speaking and interacting with other students(your peers). You are responsible for all the readings, even if the material is not explicitlycovered in class. You should read the class materials prior to class and be prepared todiscuss and ask questions about the readings and assignments. You should also re-readthe material after class as not every topic would be covered during class time. Take notes as I’m teaching, as I usually let my students you have their noteswith them for all exams and quizzes. These notes will help you better understand theissues, concepts and techniques that are being presented and they are the most valuable assets of the course. I anticipate that for each session you will need to budget about 2 hoursweekly. 4   to   8   hours   weekly   are   anticipated   for   programming   challenges   andassignments, and with your test preparation, this implies that you need to budgetaverage of 120 hours of out-of-class time over the course of the semester. This timeestimate is a guide and you may need to budget more. For example, if the material isnew to you or difficult to comprehend, it will require more of your time. All communications with the instructor should be done using Harrisburg'selectronic mail service.  Any email sent a different mail system will NOT be answered. All course deliverables are individual unless mentioned. Students who participate in University-sanctioned events (like connectionleaders, e-sport, or athletics) must make prior arrangements and give the instructorample notice. Missing class for practice is not advised. One last thing: Do not fall behind and come talk to me asap. Do not wait until the end of the course to talk to me about it, it will be too late and the only advice I have for you is to retake the class next year.</CardBody>
            </Card>
            <CardDeck style={{marginBottom: '20px'}}>
