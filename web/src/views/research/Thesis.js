...
const Thesis = () => {
	...
	return (
		<>
			...
			<Card>
				<CardHeader>Learning Outcomes</CardHeader>
				<CardBody>
			...
			<Card>
				<CardHeader>Syllabus</CardHeader>
				<CardBody>
					<Input type="file" placeholder="Choose a file" />
				</CardBody>
			</Card>
			<Card>
				<CardHeader>Choosing a Topic</CardHeader>
				<CardBody>
					<Input type="select">
			...
			<Card>
				<CardHeader>Choosing an Advisor</CardHeader>
				<CardBody>
					<SelectField
						items={mockFaculty}
						labelBy={i => i.last_name}
						valueBy={i => i.id}
						onSelect={value => {
							console.log(value)
							return setFaculty(value)
						}}
						selectedItem={mockFaculty.find(f => f === faculty)}
					/>
				</CardBody>
			</Card>
		</>
