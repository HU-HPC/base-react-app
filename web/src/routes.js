...
const NewResearch = React.lazy(() => import("./components/domain/research/view/NewResearch"))
...
const routes = [
	...
	{ path: "/research/project/new", exact: true, name: "New Research", component: NewResearch },
